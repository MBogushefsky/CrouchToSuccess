CREATE TABLE `frugal`.`bank_account` (
  ...
  ALTER TABLE `frugal`.`bank_account` 
...
ALTER TABLE `frugal`.`bank_account` 
CHANGE COLUMN `AvailableBalance` `AvailableBalance` DECIMAL(10,2) NULL ,
CHANGE COLUMN `CurrentBalance` `CurrentBalance` DECIMAL(10,2) NULL ;
